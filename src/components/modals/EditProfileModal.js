			  ...
			  <Modal.Body>
               ...
               <div className="form-row">
                  <Form.Group className="col-md-12">
                     ...
                     <Form.Control type="text" defaultValue={this.props.phone} placeholder="Enter Phone number" />
                  </Form.Group>
                  <Form.Group className="col-md-12">
                     <Form.Label>Email id</Form.Label>
                     <Form.Control type="text" defaultValue={this.props.email} placeholder="Enter Email id
                        "/>
                  </Form.Group>
