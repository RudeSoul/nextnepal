...
import { getCookieCart, removeCookieaccountinfo } from "../../utils/jscookies";
              ...
              <Nav activeKey={0} className="ml-auto" onSelect={this.closeMenu}>
                ...
                {this.props.user && (
                  ...
                  >
                    ...
                    <NavDropdown.Item eventKey={4.2} as={NavLink} activeclassname="active" to="/myaccount/wallet"><Icofont icon='sale-discount' /> Wallet</NavDropdown.Item>
