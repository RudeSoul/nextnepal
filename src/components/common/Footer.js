    		...
    		<>
		      ...
		      <footer className="pt-4 pb-4 text-center">
		         <Container>
		            ...
		            <small className="mt-0 mb-0"> Designed by
		            <a rel='noopener noreferrer' className="text-danger ml-1" target="_blank" href={`${this.props.firstLink}`}>{this.props.firstLinkText}</a>
		            </small>
		         </Container>
		      </footer>
		    </>
