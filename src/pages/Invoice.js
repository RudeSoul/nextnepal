...
import HeadingValue from '../components/common/HeadingValue';
		               ...
		               <Col md={8} className="mx-auto">
		                  <div className="p-5 osahan-invoice bg-white shadow-sm">
		                     <Row className="mb-5 pb-3">
		                        <Col md={8} xs={10}>
		                           <h3 className="mt-0">Thanks for choosing <strong className="text-secondary">Wedding Nepal</strong>,</h3>
								   <h4>Sushan ! Here are your order details: </h4>
		                        </Col>
		                     ...
		                     <Row>
		                        ...
		                        <Col md={6}>
		                           ...
		                           />
		                           <HeadingValue 
		                           		heading='2049, sankhamul, kathmandu, Nepal'
		                           />
		                        </Col>
		                     </Row>
		                     <Row className="mt-5">
		                        <Col md={12}>
		                           ...
		                           />
		                           <h6 className="mb-1 text-black"><strong>Catering Nepal</strong></h6>
		                           <HeadingValue 
		                           		heading='Shop 3, Banglamukhi, Sankhamul, Nepal'
		                           />
